...
const Express: React.FC = () => {
    ...
    function doSelectLokasi(id:any, lokasi:any, svc_id:any, hub_id:any){
        ...
        if(isSelectInput === 'Pengirim'){
            if(isHUBPenerima !== ''){
                data.append('hub_source', String(hub_id))
                data.append('hub_dest', isHUBPenerima)
                $.ajax({
                    type: "POST",
                    url: "https://xpdcargo.id/login/Callback/apiCekValidExpress",
                    data: data,
                    processData: false,
                    contentType: false,
                    dataType: "JSON",
                    ...
                    success:function(r:any){
                        ...
                        if(r.code === 200){
                            ...
                            showToast('Lokasi belum tersedia untuk layanan express', 'danger', 1200, 'top')
                        }
                    }
                })
            }else{
            ...
            if(isHUBPengirim !== ''){
                ...
                data.append('hub_dest', String(hub_id))
                $.ajax({
                    type: "POST",
                    url: "https://xpdcargo.id/login/Callback/apiCekValidExpress",
                    data: data,
    ...
    function BTPrint(){
        ...
        const cmdstest = [
            'SIZE 70 mm,80 mm',
            'CLS',
            `TEXT 0, 10, "2", 0, 1, 1, "INFORMASI BARANG (Express)"`,
